...
export class AccountService {
  ...
  fetch(): Observable<HttpResponse<Account>> {
    ...
    return this.http.get<Account>(SERVER_API_URL + 'apis/account', { headers: headerOptions, observe: 'response' });
  }

  save(account: any): Observable<HttpResponse<any>> {
    const headerOptions = new HttpHeaders().set('Accept', HEADER_ACCEPT_ACCOUNT_ANONYMOUS);
    return this.http.post(SERVER_API_URL + 'apis/account', account, { headers: headerOptions, observe: 'response' });
  }
