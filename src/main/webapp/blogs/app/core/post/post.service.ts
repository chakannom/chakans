...
export class PostService {
    ...
    createPost(blogId: number, post: IPost): Observable<HttpResponse<IPost>> {
        ...
        return this.http
            .post<IPost>(`${this.resourceUrl}/${blogId}/posts`, post, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
    ...
    updatePost(blogId: number, post: IPost): Observable<HttpResponse<IPost>> {
        const headers = new HttpHeaders().set('Accept', HEADER_ACCEPT_BLOG_V1_USER);
        return this.http
            .put<IPost>(`${this.resourceUrl}/${blogId}/posts`, post, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
    ...
    patchPost(blogId: number, post: IPost, fields: string[]): Observable<HttpResponse<IPost>> {
        ...
        return this.http
            .patch<IPost>(`${this.resourceUrl}/${blogId}/posts`, post, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
    ...
    getPosts(blogId: number, req?: any): Observable<HttpResponse<IPost[]>> {
        ...
        return this.http.get<IPost[]>(`${this.resourceUrl}/${blogId}/posts`, { headers: headers, params: options, observe: 'response' });
    }

    getPost(blogId: number, postId: number): Observable<HttpResponse<IPost>> {
        const headers = new HttpHeaders().set('Accept', HEADER_ACCEPT_BLOG_V1_USER);
        return this.http
            .get<IPost>(`${this.resourceUrl}/${blogId}/posts/${postId}`, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
    ...
    deletePost(blogId: number, postId: number): Observable<HttpResponse<any>> {
        const headers = new HttpHeaders().set('Accept', HEADER_ACCEPT_BLOG_V1_USER);
        return this.http
            .delete(`${this.resourceUrl}/${blogId}/posts/${postId}`, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
}
