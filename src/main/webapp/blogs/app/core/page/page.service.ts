...
export class PageService {
    ...
    createPage(blogId: number, page: IPage): Observable<HttpResponse<IPage>> {
        ...
        return this.http
            .post<IPage>(`${this.resourceUrl}/${blogId}/pages`, page, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
    ...
    updatePage(blogId: number, page: IPage): Observable<HttpResponse<IPage>> {
        const headers = new HttpHeaders().set('Accept', HEADER_ACCEPT_BLOG_V1_USER);
        return this.http
            .put<IPage>(`${this.resourceUrl}/${blogId}/pages`, page, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
    ...
    patchPage(blogId: number, page: IPage, fields: string[]): Observable<HttpResponse<IPage>> {
        ...
        return this.http
            .patch<IPage>(`${this.resourceUrl}/${blogId}/pages`, page, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
    ...
    getPages(blogId: number, req?: any): Observable<HttpResponse<IPage[]>> {
        ...
        return this.http
            .get<IPage[]>(`${this.resourceUrl}/${blogId}/pages`, { headers: headers, params: options, observe: 'response' })
            .pipe(delay(100));
    }
    ...
    getPage(blogId: number, pageId: number): Observable<HttpResponse<IPage>> {
        const headers = new HttpHeaders().set('Accept', HEADER_ACCEPT_BLOG_V1_USER);
        return this.http
            .get<IPage>(`${this.resourceUrl}/${blogId}/pages/${pageId}`, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
    ...
    deletePage(blogId: number, pageId: number): Observable<HttpResponse<any>> {
        const headers = new HttpHeaders().set('Accept', HEADER_ACCEPT_BLOG_V1_USER);
        return this.http
            .delete(`${this.resourceUrl}/${blogId}/pages/${pageId}`, { headers: headers, observe: 'response' })
            .pipe(delay(100));
    }
}
