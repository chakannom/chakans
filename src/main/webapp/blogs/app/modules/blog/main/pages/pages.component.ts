...
@Component({
    selector: 'cks-blogs-blog-pages',
    templateUrl: './pages.component.html',
    styleUrls: ['../main.css', './pages.css']
})
export class BlogPagesComponent implements OnInit, OnDestroy {
    ...
    moveToDraft(pageId: number) {
        ...
        this.pageService
            ...
            .subscribe(
                (res: HttpResponse<any>) => this.onSuccessMoveToDraft(res.body, res.headers, { pageId: pageId }),
                (res: HttpResponse<any>) => this.onError(res.body)
            );
    }
    ...
    publish(pageId: number) {
        ...
        this.pageService
            .patchPage(this.blogId, page, ['status'])
            .subscribe(
                (res: HttpResponse<any>) => this.onSuccessPublish(res.body, res.headers, { pageId: pageId }),
                (res: HttpResponse<any>) => this.onError(res.body)
            );
    }
    ...
    trash(pageId: number) {
        ...
        this.pageService
            .patchPage(this.blogId, page, ['status'])
            .subscribe(
                (res: HttpResponse<any>) => this.onSuccessTrash(res.body, res.headers, { pageId: pageId }),
                (res: HttpResponse<any>) => this.onError(res.body)
            );
    }
    ...
    deleteFromTrash(pageId: number) {
        this.pageService
            ...
            .subscribe(
                (res: HttpResponse<any>) => this.onSuccessDeleteFromTrash(res.body, res.headers, { pageId: pageId }),
                (res: HttpResponse<any>) => this.onError(res.body)
            );
    }
