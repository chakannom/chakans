...
@Component({
    selector: 'cks-blogs-blog-comments',
    templateUrl: './comments.component.html',
    styleUrls: ['../main.css', './comments.css']
})
export class BlogCommentsComponent implements OnInit, OnDestroy {
    ...
    spam(commentId: number) {
        ...
        this.commentService
            ...
            .subscribe(
                (res: HttpResponse<any>) => this.onSuccessSpam(res.body, res.headers, { commentId: commentId }),
                (res: HttpResponse<any>) => this.onError(res.body)
            );
    }
    ...
    publish(commentId: number) {
        ...
        this.commentService
            .patchComment(this.blogId, comment, ['status'])
            .subscribe(
                (res: HttpResponse<any>) => this.onSuccessPublish(res.body, res.headers, { commentId: commentId }),
                (res: HttpResponse<any>) => this.onError(res.body)
            );
    }
    ...
    trash(commentId: number) {
        ...
        this.commentService
            .patchComment(this.blogId, comment, ['status'])
            .subscribe(
                (res: HttpResponse<any>) => this.onSuccessTrash(res.body, res.headers, { commentId: commentId }),
                (res: HttpResponse<any>) => this.onError(res.body)
            );
    }
    ...
    deleteFromTrash(commentId: number) {
        this.commentService
            ...
            .subscribe(
                (res: HttpResponse<any>) => this.onSuccessDeleteFromTrash(res.body, res.headers, { commentId: commentId }),
                (res: HttpResponse<any>) => this.onError(res.body)
            );
    }
