...
package com.chakans.core.tools;
...
public class RunProcess {
    ...
    public int run(boolean waitForProcess, String... args) throws IOException {
        return run(waitForProcess, null, Arrays.asList(args));
    }

    public int run(boolean waitForProcess, Map<String, String> env, String... args) throws IOException {
        return run(waitForProcess, env, Arrays.asList(args));
    }

    protected int run(boolean waitForProcess, Map<String, String> env, Collection<String> args)
        throws IOException {
