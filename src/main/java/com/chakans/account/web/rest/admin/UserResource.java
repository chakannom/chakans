package com.chakans.account.web.rest.admin;
...
import com.chakans.core.web.rest.errors.BadRequestAlertException;
import com.chakans.core.web.rest.errors.EmailAlreadyUsedException;
import com.chakans.core.web.rest.errors.LoginAlreadyUsedException;
 ...
 */
@RestController("account-admin-user-resource")
@RequestMapping(value = "/apis", produces = Constants.APPLICATION_VND_ACCOUNT_ADMIN_JSON)
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            mailSenderService.sendCreationEmail(newUser);
            return ResponseEntity.created(new URI("/apis/users/" + newUser.getLogin()))
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String login) {
        ...
        return ResponseUtil.wrapOrNotFound(userService.getUserWithAuthoritiesAndAgreementsByLogin(login));
    }
