...
/**
 * Integration tests for {@link MailSenderService}.
 */
@SpringBootTest(classes = ChakansApp.class)
public class MailSenderServiceIT {
    ...
    public void setup() {
        ...
        mailSenderService = new MailSenderService(jHipsterProperties, javaMailSender, messageSource, templateEngine);
    }

    @Test
    public void testSendEmail() throws Exception {
        mailSenderService.sendEmail("john.doe@example.com", "testSubject", "testContent", false, false);
    ...
    public void testSendHtmlEmail() throws Exception {
        mailSenderService.sendEmail("john.doe@example.com", "testSubject", "testContent", false, true);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getSubject()).isEqualTo("testSubject");
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo("john.doe@example.com");
    ...
    public void testSendMultipartEmail() throws Exception {
        mailSenderService.sendEmail("john.doe@example.com", "testSubject", "testContent", true, false);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
    ...
    public void testSendMultipartHtmlEmail() throws Exception {
        mailSenderService.sendEmail("john.doe@example.com", "testSubject", "testContent", true, true);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        MimeMultipart mp = (MimeMultipart) message.getContent();
        MimeBodyPart part = (MimeBodyPart) ((MimeMultipart) mp.getBodyPart(0).getContent()).getBodyPart(0);
    ...
    public void testSendEmailFromTemplate() throws Exception {
        ...
        user.setLangKey("en");
        mailSenderService.sendEmailFromTemplate(user, "mail/testEmail", "email.test.title");
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
    ...
    public void testCreationEmail() throws Exception {
        ...
        user.setLogin("john");
        user.setEmail("john.doe@example.com");
        mailSenderService.sendCreationEmail(user);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(user.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo(jHipsterProperties.getMail().getFrom());
    ...
    public void testSendPasswordResetMail() throws Exception {
        ...
        user.setLogin("john");
        user.setEmail("john.doe@example.com");
        mailSenderService.sendPasswordResetMail(user);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(user.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo(jHipsterProperties.getMail().getFrom());
